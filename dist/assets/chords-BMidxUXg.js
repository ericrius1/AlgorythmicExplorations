import{i as ne}from"./siteNav-DaR1fllU.js";import{S as _,g as K,m as ae}from"./demoShell-Btkj803W.js";import{g as W}from"./gpu-DBowy6aD.js";import{S as X}from"./shaderCanvas-B9soO7i5.js";import{s as Z,S as F,m as G,f as ee,u as E,n as re,d as M,N as te,e as ie}from"./audio-Cx45zrED.js";import{P as le}from"./piano-CIs-qSHE.js";import{P as oe}from"./PolySynth-CMSO9RJ7.js";import{R as ce}from"./Reverb-xLBcSWPW.js";const q=6,ue=130.81,z=[{name:"major",iv:[0,4,7],story:"4:5:6 — a slice of one harmonic series"},{name:"minor",iv:[0,3,7],story:"10:12:15 — same intervals, weaker anchor"},{name:"diminished",iv:[0,3,6],story:"no simple lattice — pure instability"},{name:"augmented",iv:[0,4,8],story:"perfectly symmetric — no home, no root"},{name:"sus4",iv:[0,5,7],story:"6:8:9 — the third withheld, neither happy nor sad"},{name:"dom7",iv:[0,4,7,10],story:"major plus a tritone inside — the engine of part five"},{name:"maj7",iv:[0,4,7,11],story:"8:10:12:15 — soft dissonance worn as perfume"},{name:"min7",iv:[0,3,7,10],story:"10:12:15:18 — minor with the edges sanded"}],fe=`
fn xOf(f: f32) -> f32 {
