// GridSort for 32-byte particles (vec4 pos/vel + vec4 aux). Same counting
// sort as gridSort.ts, but the scatter carries the auxiliary lane along so
// per-particle state like temperature survives the reorder.

import gridShader from "../shaders/gridsort2.wgsl?raw";

export const GRID = 256;
export const CELLS = GRID * GRID;
const WG = 256;
const BLOCKS = CELLS / WG;

export class GridSort2 {
